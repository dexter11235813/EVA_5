...
from numpy import transpose, floor, ceil, sqrt, clip
from dataloader import get_iterators
import matplotlib.pyplot as plt
import config
import torch
...
def plot_images_by_classification(
    ...
    if misclassified:
        save_path = f"{save_path}/misclassified_images.png"
    else:
        save_path = f"{save_path}/correctly_classified_images.png"
